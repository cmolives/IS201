...
Globalize.b1536089130 = messageFormatterFn((function(  ) {
  return function(d) { return "Custom SQL Query"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1148503654 = messageFormatterFn((function(  ) {
  return function(d) { return "Custom SQL is used in this " + d.contentType + "."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1268166836 = messageFormatterFn((function(  ) {
  return function(d) { return "Upstream lineage might be incomplete when a " + d.contentType + " uses custom SQL."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b1561865936 = messageFormatterFn((function(  ) {
...
Globalize.b1449197063 = messageFormatterFn((function(  ) {
  return function(d) { return "We're having trouble highlighting this data mark in the view."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b1620152174 = messageFormatterFn((function(  ) {
  return function(d) { return "Recorded " + d.RELATIVE_TIME + ", " + d.TIMESTAMP; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b744578164 = messageFormatterFn((function(  ) {
  return function(d) { return d.MEASURE_NAME + " recorded on"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b106716710 = messageFormatterFn((function(  ) {
  return function(d) { return "measure value recorded on"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1483425244 = messageFormatterFn((function(  ) {
...
Globalize.a1070272938 = messageFormatterFn((function(  ) {
  return function(d) { return "Contributing to the value of a measure:\n\nThis explanation type indicates when the distribution of values across an unvisualized dimension may be contributing to the aggregate value of the explained mark. This type of explanation is used for sums, counts, and averages.\n\nUnique Attributes:\n\nThis explanation type can also indicate that the distribution of values across an unvisualized dimension in the explained mark is unusual in contrast to the distribution of values for all other marks in the view.\n\nAn unvisualized dimension is a dimension that exists in the data source, but isn't currently being used in the view."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b1363098009 = messageFormatterFn((function(  ) {
  return function(d) { return "Contributing to the value of a measure:\n\nThis explanation type indicates when a single value in an unvisualized dimension may be contributing to the aggregate value of the explained mark. This explanation reveals when every underlying record of a dimension has the same value.\n\nUnique Attributes:\n\nThis explanation type can also indicate that the value of the explained mark is unusual in contrast to the distribution of values for all other marks in the view.\n\nAn unvisualized dimension is a dimension that exists in the data source, but isn't currently being used in the view."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1234562967 = messageFormatterFn((function(  ) {
  return function(d) { return "Explore measure values for " + d.analyzedMark; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b2018563008 = messageFormatterFn((function(  ) {
  return function(d) { return "Explanations listed here reveal possible reasons why the target measure value for the analyzed mark is different from other marks."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1228961385 = messageFormatterFn((function(  ) {
  return function(d) { return "Explanations listed here reveal possible reasons why the analyzed mark is different from other marks, independent of the measure values in the view."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b793800359 = messageFormatterFn((function(  ) {
  return function(d) { return "Unique attributes of " + d.analyzedMark; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1863988908 = messageFormatterFn((function(  ) {
  return function(d) { return "Considering the distribution of current values in the data, this value is expected to be between " + d.low + " and " + d.high + ". This takes into account the filters set on " + d.fieldCaptions + "."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1041644187 = messageFormatterFn((function(  ) {
  return function(d) { return "Considering the distribution of current values in the data, this value is expected to be between " + d.low + " and " + d.high + "."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b207239137 = messageFormatterFn((function(  ) {
  return function(d) { return "Considering the distribution of current values in the data, this value is expected to be between " + d.low + " and " + d.high + ". This takes into account the filter set on " + d.fieldCaption + "."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1282228085 = messageFormatterFn((function(  ) {
  return function(d) { return "One record out of " + d.numberOfRows + " records has an extreme value that is increasing the expected " + d.aggTargetMeasureName + "."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b370492463 = messageFormatterFn((function(  ) {
  return function(d) { return "One record out of " + d.numberOfRows + " records has an extreme value that is decreasing the expected " + d.aggTargetMeasureName + "."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1153686543 = messageFormatterFn((function(  ) {
  return function(d) { return "The analyzed mark " + d.analyzedMark + " is made of " + d.numberOfRows + " records. One record with a value of " + d.outlierValue + " falls outside the expected range for the records in this mark."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b371700611 = messageFormatterFn((function(  ) {
  return function(d) { return d.X + " records out of " + d.numberOfRows + " records have extreme values that are increasing the expected " + d.aggTargetMeasureName + "."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b2024421159 = messageFormatterFn((function(  ) {
  return function(d) { return d.X + " records out of " + d.numberOfRows + " records have extreme values that are decreasing the expected " + d.aggTargetMeasureName + "."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1666695401 = messageFormatterFn((function(  ) {
  return function(d) { return "The analyzed mark " + d.analyzedMark + " is made of " + d.numberOfRows + " records. " + d.X + " records with extreme values fall outside the expected range for the records in this mark."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b143030625 = messageFormatterFn((function(  ) {
  return function(d) { return "This chart shows all records of " + d.measureCaption + " in the analyzed mark. The extreme value " + d.outlierValue + " is highlighted."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1510116247 = messageFormatterFn((function(  ) {
  return function(d) { return "This chart shows all records of " + d.measureCaption + " in the analyzed mark. The extreme values are highlighted."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1905514614 = messageFormatterFn((function(  ) {
  return function(d) { return "The average " + d.baseColumnCaption + " is increasing the expected " + d.aggTargetMeasureName + " of the analyzed mark."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a195724240 = messageFormatterFn((function(  ) {
  return function(d) { return "The average " + d.baseColumnCaption + " is decreasing the expected " + d.aggTargetMeasureName + " of the analyzed mark."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1527593355 = messageFormatterFn((function(  ) {
  return function(d) { return "Many of the underlying records in the analyzed mark have the value " + d.markValue + " for " + d.dimensionName + ", which is increasing the expected " + d.aggTargetMeasureName + "."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b509203429 = messageFormatterFn((function(  ) {
  return function(d) { return "Many of the underlying records in the analyzed mark have the value " + d.markValue + " for " + d.dimensionName + ", which is decreasing the expected " + d.aggTargetMeasureName + "."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1526658875 = messageFormatterFn((function(  ) {
  return function(d) { return "Many of the underlying records in the analyzed mark have the value " + d.markValue + " for " + d.dimensionName + ", which may be contributing to " + d.aggTargetMeasureName + "."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a495542445 = messageFormatterFn((function(  ) {
  return function(d) { return "Fewer of the underlying records in the analyzed mark have the value " + d.markValue + " for " + d.dimensionName + ", which is increasing the expected " + d.aggTargetMeasureName + "."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1789421383 = messageFormatterFn((function(  ) {
  return function(d) { return "Fewer of the underlying records in the analyzed mark have the value " + d.markValue + " for " + d.dimensionName + ", which is decreasing the expected " + d.aggTargetMeasureName + "."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a839501283 = messageFormatterFn((function(  ) {
  return function(d) { return "Fewer of the underlying records in the analyzed mark have the value " + d.markValue + " for " + d.dimensionName + ", which may be contributing to " + d.aggTargetMeasureName + "."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1755878859 = messageFormatterFn((function(  ) {
  return function(d) { return "The rate of a single value in an unvisualized dimension may be contributing to the aggregate value of the analyzed mark. This explanation type also indicates when every underlying record of a dimension has the same value."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b89548969 = messageFormatterFn((function(  ) {
  return function(d) { return "The distribution of values across an unvisualized dimension may be contributing to the aggregate value of the analyzed mark. This type of explanation is used for sums, counts, and averages."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a664385351 = messageFormatterFn((function(  ) {
  return function(d) { return "Relevant Dimensions"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a551424121 = messageFormatterFn((function(  ) {
  return function(d) { return "The distribution of values across an unvisualized dimension in the analyzed mark is unusual in contrast to the distribution of values for all other marks in the view."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1485511770 = messageFormatterFn((function(  ) {
  return function(d) { return "The distribution of " + d.dimension + " of the analyzed mark is different from the other marks in the view."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1078458844 = messageFormatterFn((function(  ) {
  return function(d) { return "The distribution of " + d.dimensionName + " is increasing the expected " + d.aggTargetMeasureName + " of the analyzed mark."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1701648286 = messageFormatterFn((function(  ) {
  return function(d) { return "The distribution of " + d.dimensionName + " is decreasing the expected " + d.aggTargetMeasureName + " of the analyzed mark."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b709898420 = messageFormatterFn((function(  ) {
  return function(d) { return "The distribution of " + d.dimensionName + " may be contributing to " + d.aggTargetMeasureName + ". The analyzed mark is still in the expected range."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b674414455 = messageFormatterFn((function(  ) {
  return function(d) { return "The average of an unvisualized measure may be contributing to the aggregate value of the analyzed mark."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b2060347825 = messageFormatterFn((function(  ) {
  return function(d) { return "Relevant Measures"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b846373943 = messageFormatterFn((function(  ) {
  return function(d) { return "The average " + d.measureName + " is increasing the expected " + d.aggTargetMeasureName + " of the analyzed mark."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b308688355 = messageFormatterFn((function(  ) {
  return function(d) { return "The average " + d.measureName + " is decreasing the expected " + d.aggTargetMeasureName + " of the analyzed mark."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b105522626 = messageFormatterFn((function(  ) {
  return function(d) { return "The percent of null values is increasing the expected " + d.aggTargetMeasureName + " of the analyzed mark."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1239230728 = messageFormatterFn((function(  ) {
  return function(d) { return "The percent of null values is decreasing the expected " + d.aggTargetMeasureName + " of the analyzed mark."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b613646734 = messageFormatterFn((function(  ) {
  return function(d) { return "The percent of null values may be contributing to " + d.aggTargetMeasureName + "."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a980710890 = messageFormatterFn((function(  ) {
  return function(d) { return "All: Last 14 days"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b559144632 = messageFormatterFn((function(  ) {
  return function(d) { return "Latest: Last 24 hours"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b1200006159 = messageFormatterFn((function(  ) {
  return function(d) { return "No unexpected data change has been found in this view in over 14 days."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a910209002 = messageFormatterFn((function(  ) {
  return function(d) { return "No unexpected data change has been found in this view in the past 24 hours."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b590291861 = messageFormatterFn((function(  ) {
  return function(d) { return d.aggTargetMeasureName + ": lower than predicted"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b660080369 = messageFormatterFn((function(  ) {
  return function(d) { return d.aggTargetMeasureName + ": higher than predicted"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a216566227 = messageFormatterFn((function(  ) {
  return function(d) { return "Tableau found that " + d.aggTargetMeasureName + " " + d.unexpectedValue + " was lower than predicted, " + d.timeStamp + "."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a146777719 = messageFormatterFn((function(  ) {
  return function(d) { return "Tableau found that " + d.aggTargetMeasureName + " " + d.unexpectedValue + " was higher than predicted, " + d.timeStamp + "."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b108061399 = messageFormatterFn((function(  ) {
  return function(d) { return d.aggTargetMeasureName + " for " + d.dimensionNames; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a629294003 = messageFormatterFn((function(  ) {
  return function(d) { return "Recorded " + d.RELATIVE_TIME + ", " + d.TIMESTAMP; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1608229025 = messageFormatterFn((function(  ) {
  return function(d) { return "Lower than expected range"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1962271988 = messageFormatterFn((function(  ) {
  return function(d) { return "Within expected range"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b891476177 = messageFormatterFn((function(  ) {
  return function(d) { return "Higher than expected range"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1928096193 = messageFormatterFn((function(  ) {
  return function(d) { return "Indexing allows Ask Data to quickly retrieve field values. Last completed:"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a155611138 = messageFormatterFn((function(  ) {
  return function(d) { return "Show template project contributors!"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b453405305 = messageFormatterFn((function(  ) {
  return function(d) { return "Hide template project contributors!"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1983738672 = messageFormatterFn((function(  ) {
  return function(d) { return "Performance Checks"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a382676720 = messageFormatterFn((function(  ) {
  return function(d) { return "Select an item to learn about performance checks conducted and how to resolve issues before publishing."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1472372142 = messageFormatterFn((function(  ) {
  return function(d) { return "Critical issues can severely impact workbook performance and have adverse effects for the end user. For best results fix all critical issues."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a408220097 = messageFormatterFn((function(  ) {
  return function(d) { return "Warnings can potentially impact end users but will have less adverse effects if published. Use your discretion to fix warnings."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b727839839 = messageFormatterFn((function(  ) {
  return function(d) { return "All items passed meet best practice guidelines. You can learn more about best practices and performance checks by clicking into individual items."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1123098609 = messageFormatterFn((function(  ) {
  return function(d) { return "Show template project contributors!"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a514082166 = messageFormatterFn((function(  ) {
  return function(d) { return "Hide template project contributors!"; }
})(), Globalize("en").pluralGenerator({}));
}));
